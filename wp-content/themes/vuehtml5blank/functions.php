...
{
    wp_enqueue_style('child-style', "https://" . $_SERVER['HTTP_HOST'] . "/wp-content/themes/vuehtml5blank/style.css");
}
...
{
    echo "<script src=\"https://" . $_SERVER['HTTP_HOST'] . "/wp-content/themes/vuehtml5blank/app.js\"></script>";
}
